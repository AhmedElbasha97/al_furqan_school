...
import 'package:al_furqan_school/views/appData/newsDetails/NewsDetailsScreen.dart';
...
class ContainerCardWidget extends StatelessWidget {
  ...
  const ContainerCardWidget(
      { Key? key, this.title, this.bg, this.subTtitle, this.buttonNavigation, this.newId})
      : super(key: key);
  @override
